...
drop_objava_table = "DROP TABLE IF EXISTS dogodek;"
cur.execute(drop_objava_table)
conn.commit()

create_rezultat_tekmovanje_table = '''CREATE TABLE dogodek (
...
for values in values:
    insert_statement = "INSERT INTO dogodek (Tekmovanje_ID, objava_ID) VALUES (%s, %s);"
